use app::{
  api::mg::{
    index::{
      ...
      __cmd__save as __cmd__app__mg__save, __cmd__save_as as __cmd__app__mg__save_as,
      get_init_data as app__mg__get_init_data, load as app__mg__load, save as app__mg__save,
